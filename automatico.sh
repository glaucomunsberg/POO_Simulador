...
project="POO_Simulador"			    #Desbloqueado no Automatico.sh para conter o nome do projeto do Github
...
function criar_automatico()
{
	...
	if [ $enter = "Y" -o $enter = "y" ]; then
		...
		sed "s/project="POO_Simulador"/project=\"$project\"/g" "temp1.sh" > "temp2.sh"
		echo "-    |--------------------%50                    |      -"
